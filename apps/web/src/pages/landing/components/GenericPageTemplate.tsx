        ...
        <div className='max-w-6xl mx-auto'>
          <div className={`grid gap-8 lg:gap-12 ${data.blocks.length === 2 ? 'md:grid-cols-2' : 'grid-cols-1 max-w-4xl mx-auto'}`}>
            {data.blocks.map((block, idx) => (
              <div
                key={idx}
                className={`group space-y-6 p-8 md:p-10 rounded-[2.5rem] transition-all duration-500 border ${idx % 2 === 0
              ...
              >
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg transition-transform group-hover:scale-110 ${idx % 2 === 0
