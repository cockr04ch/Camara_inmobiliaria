...
export default function PadiPage() {
  ...
  return (
    <div className={`min-h-screen font-sans transition-colors duration-500 ${darkMode ? 'dark bg-[#011a14] text-slate-100' : 'bg-slate-50 text-slate-800'}`}>
      ...
      <section id="inscripcion" className="py-24 px-6 lg:px-20 bg-white dark:bg-[#022c22] border-t border-slate-200 dark:border-cyan-500/20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-cyan-500">Comienza aquí</p>
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight text-slate-900 dark:text-white">
              Preinscripción al PADI
            </h2>
          ...
          <div className="rounded-[2.5rem] p-8 md:p-14 border border-slate-200 dark:border-cyan-500/20 bg-slate-50 dark:bg-[#011a14]">
            <PreinscripcionProgramaForm programaCodigo="PADI" ctaLabel="Preinscribirme al PADI" />
          </div>
        </div>
      </section>
